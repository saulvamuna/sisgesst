...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'position'                          => 'Cargo',
        'city'                              => 'Ciudad',
        'economic_sector'                   => 'Sector economico',
        ...
        'taskId'                            => 'tarea',
        'dangerClassification'              => 'clasificacion del peligro',
        'dangerDescription'                 => 'descripcion del peligro',
        'danger'                            => 'Peligro',
        'effects'                           => 'efectos posibles',
        'source'                            => 'fuente',
        'means'                             => 'medio',
        'individual'                        => 'individuo',
        'deficiencyId'                      => 'nivel de deficiencia',
        'exposureId'                        => 'nivel de exposicion',
        'probabilityValue'                  => 'nivel de probabilidad',
        'consequenceId'                     => 'nivel de consecuencia',
        'interventionValue'                 => 'nivel riesgo de intervencion',
        'interventionName'                  => 'aceptabilidad de riesgo',
        'linked'                            => 'vinculados',
        'contractor'                        => 'contratistas',
        'temporary'                         => 'temporales',
        'time'                              => 'tiempo de exposicion',
        'removal'                           => 'eliminacion',
        'removalSuggestion'                 => 'sugerencia eliminacion',
        'replacement'                       => 'sustitucion',
        'replacementSuggestion'             => 'sugerencia sustitucion',
        'engineeringControl'                => 'control de ingenieria',
        'engineeringControlSuggestion'      => 'sugerencia control de ingenieria',
        'administrativeControl'             => 'señalizacion, advertencias o controles administrativos',
